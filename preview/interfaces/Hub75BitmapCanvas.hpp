#ifndef PREVIEW_HUB75_BITMAP_CANVAS_HPP
#define PREVIEW_HUB75_BITMAP_CANVAS_HPP
...
namespace services
{
    class Hub75BitmapCanvas
        : public hal::Canvas
    {
    public:
        Hub75BitmapCanvas(infra::Hub75Bitmap& bitmap, hal::Hub75BitmapPainter& bitmapPainter);
    ...
    private:
        ...
        hal::Hub75BitmapPainter& bitmapPainter;
    };
}

//#include "preview/interfaces/Hub75BitmapPainter.hpp"
//
//namespace hal
//{
//    void Hub75BitmapPainterCanonical::DrawPixel(infra::Hub75Bitmap& bitmap, infra::Point position, infra::Colour colour, infra::Region boundingBox)
//    {
...
//    }
//
//    void Hub75BitmapPainterCanonical::DrawLine(infra::Hub75Bitmap& bitmap, infra::Point from, infra::Point to, infra::Colour colour, infra::Region boundingBox)
//    {
//        if (from.y == to.y)
...
//    }
//
//    void Hub75BitmapPainterCanonical::DrawRectangle(infra::Hub75Bitmap& bitmap, infra::Region position, infra::Colour colour, infra::Region boundingBox)
//    {
...
//    }
//
//    void Hub75BitmapPainterCanonical::DrawFilledRectangle(infra::Hub75Bitmap& bitmap, infra::Region position, infra::Colour colour, infra::Region boundingBox)
//    {
...
//    }
//
//    void Hub75BitmapPainterCanonical::DrawRoundedRectangle(infra::Hub75Bitmap& bitmap, infra::Region position, uint16_t r, infra::Colour colour, infra::Region boundingBox)
//    {
...
//    }
//
//    void Hub75BitmapPainterCanonical::DrawFilledRoundedRectangle(infra::Hub75Bitmap& bitmap, infra::Region position, uint16_t r, infra::Colour colour, infra::Region boundingBox)
//    {
//        assert(position.Width() >= 2 * r);
//        assert(position.Height() >= 2 * r);
//
...
//    }
//
//    void Hub75BitmapPainterCanonical::DrawCircle(infra::Hub75Bitmap& bitmap, infra::Point centre, int16_t r, infra::Colour colour, infra::Region boundingBox)
//    {
//        int16_t f = 1 - r;
//        int16_t ddF_x = 1;
//        int16_t ddF_y = -2 * r;
...
//    }
//
//    void Hub75BitmapPainterCanonical::DrawCircle(infra::Hub75Bitmap& bitmap, infra::Point centre, int16_t rSmall, int16_t rLarge, infra::Colour colour, infra::Region boundingBox)
//    {
...
//    }
//
//    void Hub75BitmapPainterCanonical::DrawFilledCircle(infra::Hub75Bitmap& bitmap, infra::Point centre, int16_t r, infra::Colour colour, infra::Region boundingBox)
//    {
//        int16_t f = 1 - r;
//        int16_t ddF_x = 1;
//        int16_t ddF_y = -2 * r;
...
//    }
//
//    void Hub75BitmapPainterCanonical::DrawHub75Bitmap(infra::Hub75Bitmap& bitmap, infra::Point position, const infra::Hub75Bitmap& sourceHub75Bitmap, infra::Region boundingBox)
//    {
//        auto bitmapDestination = infra::Region(position, sourceHub75Bitmap.size);
...
//                    {
//                        bool colour = sourceHub75Bitmap.BlackAndWhitePixel(infra::Point(x, y));
...
//                    for (auto x = boundedDestination.Left() - bitmapDestination.Left(); x != boundedDestination.Right() - bitmapDestination.Left(); ++x)
//                    {
//                        auto colour = sourceHub75Bitmap.PixelColour(infra::Point(x, y));
//                        DrawPixel(bitmap, bitmapDestination.TopLeft() + infra::Vector(x, y), colour);
//                    }
//        }
//    }
//
//    void Hub75BitmapPainterCanonical::DrawTransparentHub75Bitmap(infra::Hub75Bitmap& bitmap, infra::Point position, const infra::Hub75Bitmap& sourceHub75Bitmap, uint32_t transparencyColour, infra::Region boundingBox)
//    {
//        assert(bitmap.pixelFormat == sourceHub75Bitmap.pixelFormat);
//        auto bitmapDestination = infra::Region(position, sourceHub75Bitmap.size);
//        auto boundedDestination = bitmapDestination & boundingBox;
//
//        if (!boundedDestination.Empty())
...
//    }
//
//    void Hub75BitmapPainterCanonical::DrawIcon(infra::Hub75Bitmap& bitmap, infra::Point position, const infra::Hub75Bitmap& sourceHub75Bitmap, infra::Colour colour, infra::Region boundingBox)
//    {
//        assert(sourceHub75Bitmap.pixelFormat == infra::PixelFormat::blackandwhite);
//        auto iconDestination = infra::Region(position, sourceHub75Bitmap.size);
...
//                {
//                    if (sourceHub75Bitmap.BlackAndWhitePixel(infra::Point(x, y)))
//                        DrawPixel(bitmap, iconDestination.TopLeft() + infra::Vector(x, y), convertedColour);
//                }
//        }
//    }
//
//    void Hub75BitmapPainterCanonical::DrawString(infra::Hub75Bitmap& bitmap, infra::Point position, infra::BoundedConstString string, const infra::Font& font, infra::Colour colour, infra::RightAngle direction, infra::Region boundingBox)
//    {
//        for (auto c : string)
//            position = DrawCharacter(bitmap, position, c, font, colour, direction, boundingBox);
//    }
//
//    void Hub75BitmapPainterCanonical::WaitUntilDrawingFinished() const
//    {}
//
//    void Hub75BitmapPainterCanonical::DrawHorizontalLine(infra::Hub75Bitmap& bitmap, infra::Point from, uint16_t deltaX, infra::Colour colour, infra::Region boundingBox)
//    {
...
//    }
//
//    void Hub75BitmapPainterCanonical::DrawHorizontalLine(infra::Hub75Bitmap& bitmap, infra::Point from, uint16_t deltaX, infra::Colour colour)
//    {
//        if (deltaX > 0)
//        {
//            WaitUntilDrawingFinished();
...
//    }
//
//    void Hub75BitmapPainterCanonical::DrawVerticalLine(infra::Hub75Bitmap& bitmap, infra::Point from, uint16_t deltaY, infra::Colour colour, infra::Region boundingBox)
//    {
...
//    }
//
//    void Hub75BitmapPainterCanonical::DrawVerticalLine(infra::Hub75Bitmap& bitmap, infra::Point from, uint16_t deltaY, infra::Colour colour)
//    {
//        if (deltaY > 0)
//        {
//            WaitUntilDrawingFinished();
...
//    }
//
//    infra::Point Hub75BitmapPainterCanonical::DrawCharacter(infra::Hub75Bitmap& bitmap, infra::Point position, char c, const infra::Font& font, infra::Colour colour, infra::RightAngle direction, infra::Region boundingBox)
//    {
...
//        auto backRotatedHub75BitmapRegion = infra::RotatedRegionInRegion(bitmapRegion, -direction, bitmapRegion);
...
//        auto glyphRegion = infra::RotatedRegionInRegion(unrotatedGlyphRegion, direction, backRotatedHub75BitmapRegion);
//
...
//                {
//                    auto pixelPosition = infra::RotatedPointInRegion(unrotatedGlyphRegion.TopLeft() + infra::Vector(x, y), direction, backRotatedHub75BitmapRegion);
...
//    }
//
//    void Hub75BitmapPainterCanonical::DrawPixel(infra::Hub75Bitmap& bitmap, infra::Point position, uint32_t colour)
//    {
//        if (bitmap.pixelFormat == infra::PixelFormat::blackandwhite)

#ifndef PREVIEW_WINDOW_BITMAP_CANVAS_HPP
#define PREVIEW_WINDOW_BITMAP_CANVAS_HPP
...
namespace services
{
    class WindowBitmapCanvas
        : public hal::Canvas
    {
    public:
        WindowBitmapCanvas(infra::Vector size, infra::Bitmap& bitmap, infra::Vector shift, hal::BitmapPainter& bitmapPainter);
    ...
    public:
        ...
        void DrawBitmap(infra::Point position, const infra::SimpleBitmap& sourceBitmap, infra::Region boundingBox) override;
        void DrawTransparentBitmap(infra::Point position, const infra::SimpleBitmap& sourceBitmap, uint32_t transparencyColour, infra::Region boundingBox) override;
        void DrawIcon(infra::Point position, const infra::SimpleBitmap& sourceBitmap, infra::Colour colour, infra::Region boundingBox) override;
